...
; Get the Font's File name
  ...
  IfFileExists "$FONTS\${FontFileName}" ${Index} "${Index}-New"
...
"${Index}-GO:"
  ClearErrors
  !insertmacro FontName "$FONTS\${FontFileName}"
  pop $R2
...
; Get the Font's File name
  ...
  IfFileExists "$FONTS\${FontFileName}" ${Index} "${Index}-End"
...
"${Index}-9x:"
  ...
  "${Index}-NotEmpty:"
    Delete /REBOOTOK "$FONTS\${FontFileName}"
    goto "${Index}-End"
  "${Index}-Skip:"
    goto "${Index}-End"
  !else
